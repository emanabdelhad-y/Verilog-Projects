...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sevenSegUsingBehavioral.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sevenSegUsingBehavioral.tcl -notrace
