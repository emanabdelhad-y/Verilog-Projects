...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sevenSegUsingBehavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sevenSegUsingBehavioral.tcl
