...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/lab5 report/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Question2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Question2.tcl -notrace
