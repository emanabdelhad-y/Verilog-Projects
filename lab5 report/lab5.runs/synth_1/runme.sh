...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/lab5 report/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Question2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Question2.tcl
