...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/lab 7/lab 7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDTimeClock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCDTimeClock.tcl -notrace
