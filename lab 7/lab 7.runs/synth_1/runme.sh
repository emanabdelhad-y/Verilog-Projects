...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/lab 7/lab 7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDTimeClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCDTimeClock.tcl
