...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/Quiz/Quiz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log series.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source series.tcl -notrace
