...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/Quiz/Quiz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log series.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source series.tcl
