...
HD_PWD='C:/Users/emanessam26/Desktop/verilog/lab 8/lab 8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalLock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalLock.tcl -notrace
